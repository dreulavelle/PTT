...
@pytest.mark.parametrize("release_name, expected_languages", [
    ...
    ("Le Labyrinthe 2014 Multi-VF2 1080p BluRay x264-PopHD", ["multi audio", "fr"]),
    ...
    ("Patriot Games [1992] Eng, Ger, Cze, Hun, Pol + multisub  DVDrip", ["multi subs", "en", "de", "pl", "cs", "hu"]),
    ("Elvis Presley - La via del Male (King creole) - IT EN FR DE ES", ["en", "fr", "es", "it", "de"]),
    ("FernGully [H264 - Ita Dut Fre Ger Eng Spa Aac - MultiSub]", ["multi subs", "en", "fr", "es", "it", "de", "nl"]),
    ("Jesus de Montreal / Jesus of Montreal - subtitulos espanol", ["es"]),
    ("Los.Vengadores.DVDR español ingles clon", ["en", "es"]),
    ("EMPIRE STATE 2013 DVDRip TRNC English and Española Latin", ["en", "es"]),
    ("Mary Poppins Returns 2019 DVDRip LATINO-1XBET", ["es"]),
    ("Los Simpsons S18 E01 Latino", ["es"]),
    ("Spider-Man (2002) Blu-Ray [720p] Dual Ingles-Español", ["dual audio", "en", "es"]),
    ("Abuela (2015) 1080p BluRay x264 AC3 Dual Latino-Inglés", ["dual audio", "en", "es"]),
    ("Dumbo.2019.1080p.Dual.Lat", ["dual audio", "es"]),
    ("A.Score.to.Settle.2019.lati.mp4", ["es"]),
    ("[S0.E04] Gambit królowej - Gra środkowa.Spanish Latin America.srt", ["es"]),
    ("Latin American.spa.srt", ["es"]),
    ...
    ("Inception 2010 1080p BRRIP[dual-audio][eng-hindi]", ["dual audio", "en", "hi"]),
    ...
    ("A.Clockwork.Orange.1971.BRDRIP.1080p.DUAL.PORT-BR.ENG.gmenezes.m", ["dual audio", "en", "pt"]),
    ...
    ("Titan.A.E.2000 720p  HDTV DTS Eng Fra Hun Rom Rus multisub", ["multi subs", "en", "fr", "ru", "hu", "ro"]),
    ("Frieren - Beyond Journey's End - S01E01 - TBA WEBDL-1080p.Latin American es.ass", ["es"]),
    ...
    ("The Mechanic [1972] Eng,Deu,Fra,Esp,Rus + multisub DVDrip", ["multi subs", "en", "fr", "es", "de", "ru"]),
    ("Mommie Dearest [1981 PAL DVD][En.De.Fr.It.Es Multisubs[18]", ["multi subs", "en", "fr", "es", "de"]), # TODO: does not include it
    ...
    ("Berserk 01-25 [dual audio JP,EN] MKV", ["dual audio", "en", "ja"]),
    ...
    ("Joker.2019.MULTi.Bluray.1080p.Atmos.7.1.En.Fr.Sp.Pt-DDR[EtHD]", ["multi audio", "en", "fr"]), # TODO: does not include sp,pt
    ...
    ("Cowboy Bebop - 1080p BDrip Audio+sub MULTI (VF / VOSTFR)", ["multi audio", "fr"]),
    ...
    ("Men in Black International (2019) 720p Korsub HDRip x264 ESub [Dual Line Audio] [Hindi English]", ["dual audio", "en", "ko", "hi"]),
    ("Fame (1980) [DVDRip][Dual][Ac3][Eng-Spa]", ["dual audio", "en", "es"]),
    ("O Rei do Show 2018 Dual Áudio 4K UtraHD By.Luan.Harper.", ["dual audio"]),
    ("Cowboy Bebop The Movie (2001) BD 1080p.x265.Tri-Audio.Ita.Eng.Jap [Rady]", ["multi audio", "en", "ja", "it"]),
