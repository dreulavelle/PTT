...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"title": "Student Council's Discretion / Seitokai no Ichizon", "seasons": [1], "resolution": "1080p", "quality": "BDRip", "audio": "aac", "codec": "hevc", "group": "neoHEVC", "languages": [], "episodes": []},
        ),
        (
        ...
        ("[DVDRip-ITA]The Fast and the Furious: Tokyo Drift [CR-Bt]", {"title": "The Fast and the Furious: Tokyo Drift", "quality": "DVDRip", "languages": ["italian"], "seasons": [], "episodes": []}),
        ("[BluRay Rip 720p ITA AC3 - ENG AC3 SUB] Hostel[2005]-LIFE[ultimafrontiera]", {"title": "Hostel", "year": 2005, "resolution": "720p", "quality": "BRRip", "audio": "ac3", "languages": ["english", "italian"], "group": "LIFE", "seasons": [], "episodes": []}),
        (
        ...
        ("[720p] The God of Highschool Season 1", {"title": "The God of Highschool", "seasons": [1], "resolution": "720p", "languages": [], "episodes": []}),
        (
