...
def add_defaults(parser: Parser):
    ...
    parser.add_handler("languages", regex.compile(r"\b(VF[FQIB2]?|(TRUE)?.?FRENCH|(VOST)?FR2?|SUBFRENCH)\b", regex.IGNORECASE), uniq_concat(value("french")), {"skipIfAlreadyFound": False})
